...
import com.example.ajaclientemovil.data.Session
...
class UserRepository(private val context: Context) {
    ...
    suspend fun performLogin(user: String, pass: String): LoginDTO? {
        ...
        val resultado = Network.login(user, pass)
        ...
        */
        if (resultado != null) {
            val (loginData, sessionId) = resultado
            ...
            if (loginData.success) {
                 ...
                 */
                Session.saveSession(context, sessionId, loginData.user.role)
                return loginData
            }
        }
    ...
    fun getCurrentRole(): String? {
        return Session.getRole(context)
    }
}